...
namespace System
{
	...
	internal struct EnumFlagIndexer<E> where E : struct, IComparable
	{
		...
		/// <summary>Initializes a new instance of the <see cref="EnumFlagIndexer{E}"/> struct.</summary>
		...
		/// <summary>Implicitly converts an instance of <see cref="EnumFlagIndexer{E}"/> to the value of enumerated type E.</summary>
		/// <param name="f">The f.</param>
		/// <returns>The result of the operator.</returns>
		public static implicit operator E(EnumFlagIndexer<E> f) => f.flags;

		/// <summary>Implicitly converts a value of E to an instance of <see cref="EnumFlagIndexer{E}"/>.</summary>
		...
		public void Clear() => flags = default(E);
		...
		public void Union(E flags) => this[flags] = true;

		/// <summary>Unions the specified flags.</summary>
		/// <param name="flags">The flags.</param>
		public void Union(IEnumerable<E> flags)
		{
			foreach (var e in flags) this[e] = true;
		}

...
namespace System.Windows.Forms.VisualStyles
{
	internal static class VisualStyleRendererExtension
	{
		...
		public static System.UInt32 GetTransitionDuration(this VisualStyleRenderer rnd, int toState, int fromState = 0)
		{
			...
			NativeMethods.GetThemeTransitionDuration(rnd.Handle, rnd.Part, fromState == 0 ? rnd.State : fromState, toState, (int)IntegerListProperty.TransitionDuration, ref dwDuration);
			return dwDuration;
		}
